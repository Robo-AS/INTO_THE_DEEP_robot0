...
@Config
@Autonomous(name = "BasketAutoBLUE_special")
public class BasketAutoBLUE_special extends LinearOpMode {
...
//                                ),
//                        new ScoreSampleAutoCommand(),
                        new InstantCommand(basketPaths::setScore1Completed),//ca sa mai mearga conditionala pentru unghiul la brat gen
...
//                        new OuttakeGoHighBasketAutoCommand(),
//                        new ScoreSampleAutoCommand(),
                        new InstantCommand(basketPaths::setScore2Completed), //ca sa mai mearga conditionala pentru unghiul la brat gen
