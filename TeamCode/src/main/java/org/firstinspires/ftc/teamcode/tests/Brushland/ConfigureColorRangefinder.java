...
@TeleOp(name = "ConfigureColorRangefinder", group = "Tests")
public class ConfigureColorRangefinder extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ColorRangefinder crf =
                new ColorRangefinder(hardwareMap.get(RevColorSensorV3.class, "brushland"));
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 30); // 20mm or closer requirement

        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 0 / 360.0 * 255, 30 / 360.0 * 255); // red higher bound = 50
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 55 / 360.0 * 255, 90 / 360.0 * 255); // yellow
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 30); // 20mm or closer requirement
