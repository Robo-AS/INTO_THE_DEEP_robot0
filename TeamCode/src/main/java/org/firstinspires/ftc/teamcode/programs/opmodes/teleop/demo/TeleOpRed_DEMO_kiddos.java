...
@Config
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "🟦TeleOpRed_Demo_kiddos🟦")
public class TeleOpRed_DEMO_kiddos extends CommandOpMode {
    ...
    public void initialize(){
        ...
        //Controling the intake button logic
                        ...
                        () -> CommandScheduler.getInstance().schedule(
                                new ConditionalCommand(
                                        ...
                                        new ConditionalCommand(
                                                ...
                                                new OuttakeGoBackToIdleFromHighBasketCommand_TELEOP(),
...
//                );
    ...
    public void run(){
        ...
        robot.loop();
        robot.extendo.loop_Demo_kiddos(gamepadEx.getLeftY());
...
//        }
        ...
        exponentialJoystickCoord_X_TURN = ((Math.pow(gamepad1.left_stick_x, 3) + liniarCoefTerm * gamepad1.left_stick_x) * contantTerm)/2;
        exponentialJoystickCoord_X_FORWARD = ((Math.pow(gamepad1.right_stick_x, 3) + liniarCoefTerm * gamepad1.right_stick_x) * contantTerm)/2;
        exponentialJoystickCoord_Y = ((Math.pow(gamepad1.right_stick_y, 3) + liniarCoefTerm * gamepad1.right_stick_y) * contantTerm)/2;
